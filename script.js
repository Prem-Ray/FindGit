...
const setdarklightmode = document.querySelector('.setdarklightmode');
let url = "https://api.github.com/users";
...
async function datasearch(api) {
  try {
    ...
    if (timestamp) {
      ...
      joiningDate.innerText = "Join date not available";
    }

    image.src = val.avatar_url || "./image/not-found.png";
    ...
    linkedIn.innerText = "Not Available"; // Not provided by GitHub API

    followersval.innerText = val.followers || 0;
    followingval.innerText = val.following || 0;
    reposval.innerText = val.public_repos || 0;
